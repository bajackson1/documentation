...
![nav.png](/documentation/assets/images/nav.png)
...
| :--: | :--: |
| ![homewire.png](/documentation/assets/images/homewire.png) | As a user, I want to see a map of the Mount Carmel Campus, so I can know where each building is <br/><br/> As a user, I want to see my progress of where I have been on campus, so I can look back and refer to them for future purposes |
| ![infowire.png](/documentation/assets/images/infowire.png) | As a user, I want to see a list of all of the different academic buildings on the Mount Carmel campus with descriptions, so I can know more information about which building is which <br/><br/> As a user, I want to see a list of all of the different residence halls on the Mount Carmel campus with descriptions, so I can know more information about which hall is for who <br/><br/> As a user, I want to see a list of all of the different dining halls on the Mount Carmel campus with descriptions, so I can know more information about which ones are which |
| ![favswire.png](/documentation/assets/images/favswire.png) | As a user, I want to save a list of buildings on campus, so I can refer to those buildings later <br/><br/> As a user, I want to see my progress of where I have been on campus, so I can look back and refer to them for future purposes |

## System Design - ERD

![ERD1.png](/adocumentation/ssets/images/ERD1.png)
![ERD2.png](/documentation/assets/images/ERD2.png)

## System Design - UML

![mile1UML.png](/documentation/assets/images/mile1UML.png)
...
![sprint1us.png](/documentation/assets/images/sprint1us.png)
...
![sprint2us.png](/documentation/assets/images/sprint2us.png)
